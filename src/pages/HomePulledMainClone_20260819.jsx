  ...
  return (
    <div className="cap-gravity cap-gravity--video" data-cap-reveal>
      <div className="cap-gravity__field">
        ...
        <div className="cap-gravity__mobile-endpoints" aria-hidden="true">
          <div className="cap-gravity__mobile-endpoint cap-gravity__mobile-endpoint--environment">
            <b>Environment</b>
            <span>Physical world</span>
          </div>
          <div className="cap-gravity__mobile-endpoint cap-gravity__mobile-endpoint--decision">
            <b>Decision</b>
            <span>Information that can support action</span>
          </div>
        </div>
      </div>
